...
```bash
# 豆包
node test/ai-chat/doubao.mjs "解释一下量子计算"

# Kimi
node test/ai-chat/kimi.mjs "帮我总结这篇文章"

# 元宝
node test/ai-chat/yuanbao.mjs "用Python写一个爬虫"

# 通义千问
node test/ai-chat/tongyi.mjs "翻译这段英文"

# 文心一言
node test/ai-chat/wenxin.mjs "写一首诗"

# DeepSeek
node test/ai-chat/deepseek.mjs "写一个冒泡排序"

# 统一入口
node test/ai-chat/cli.mjs doubao "解释量子计算"
node test/ai-chat/cli.mjs --list
```

默认使用 Playwriter 会话 1。若要指定其他会话（避免与其它任务抢占标签页）：

```bash
PW_SESSION=2 node test/ai-chat/cli.mjs kimi "你好"
```
