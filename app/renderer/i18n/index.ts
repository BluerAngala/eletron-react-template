...
import { getFeatureResources } from '@/features/i18n'
...
export const i18nReady = (async () => {
  ...
  const featureResources = await getFeatureResources()
  Object.assign(resources['zh-CN'], featureResources['zh-CN'])
  Object.assign(resources['en-US'], featureResources['en-US'])
