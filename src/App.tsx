  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 px-4 py-8 text-slate-900 sm:px-6 lg:px-8">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/2 h-72 w-184 -translate-x-1/2 bg-linear-to-r from-cyan-200/0 via-cyan-300/45 to-cyan-200/0 blur-3xl" />
      </div>

      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-8">
        <section className="overflow-hidden rounded-4xl border border-slate-200 bg-white/90 shadow-[0_24px_70px_-40px_rgba(14,116,144,0.35)] backdrop-blur">
          <div className="grid gap-8 p-6 md:grid-cols-[1.15fr_0.85fr] md:p-10">
            ...
            <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-linear-to-br from-cyan-50 to-white p-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-cyan-200 bg-linear-to-br from-cyan-50 to-sky-50 p-6 text-slate-800 shadow-[0_18px_36px_-28px_rgba(14,116,144,0.4)]">
